    ...
    <div id="wrap">
      ...
      <div class="container-fluid">
        <header class="row-fluid">
          ...
          <div class="span2">
            <img src="img/logo.jpg" width="120px" class="img-polaroid">
          </div>
				...
				<label class="radio inline">
		 		...
		 		<label class="radio inline">
		 		 ...
		 		 <div class="input-append">
   				...
   				<br/>
   				<input  type="number" name="number" placeholder="Number of vacancies"></input> <br/>
...
<div id="push"></div>
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Built with love by <a href="about.php">@satyendra.</a></p>
      </div>
    </div>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAAZex0-BbtsR6wg9ieVzrzp2umR_gOnKc&callback=initMap"></script>
